...
import com.apiserver.model.system.validator.service.VoSuserService;
...
@Constraint(validatedBy = VoSuserService.class) //执行校验逻辑的类
public @interface VoSuserValidator {
